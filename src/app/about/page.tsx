...
<div className="shadow-2xl rounded-lg p-8 w-11/12 md:w-8/12 lg:w-11/12 flex flex-col items-center">
  ...
  <p className="text-gray-700 text-lg leading-8 text-center mb-4 dark:text-white">
    My coding journey began with the *Governor Sindh Initiative for Artificial Intelligence, Web 3.0 & Metaverse*—a transformative opportunity that introduced me to the world of cutting-edge technologies. From mastering the fundamentals of HTML , CSS And Typescript, diving into the depths of Next-js, and embracing the power of Figma-UI/UX And Sanity, every milestone has shaped my passion. As I continue to grow, I aim to build innovative solutions and contribute to the tech community, sharing knowledge and empowering others along the way.
  </p>
  <p className="text-gray-700 text-lg leading-7 text-center dark:text-white">
    This journey has been an exciting adventure, filled with challenges and triumphs. Each line of code brings me closer to creating impactful projects that make a difference. I'm constantly evolving, learning, and pushing the boundaries of what's possible in the ever-changing world of technology.
  </p>
</div>
</div>
    </div>
